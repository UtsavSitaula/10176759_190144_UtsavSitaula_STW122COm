...
class Details:
    def __init__(self,root):
        ...
        self.update_index=""
        self.title = Label(self.win, text="User Details", font=("times new roman", 40, "bold"), bg="blue", fg="Black",
                      relief=GROOVE)
        ...
        self.title2 = Label(self.Frame3, text="NOTE: For User Company ID must be filled",
    ...
    def add_user(self):
        if self.number_box.get()=="" or self.owner_box.get()=="" or self.ID_box.get()=="" or self.date_box.get()=="":
